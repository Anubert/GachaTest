...
w = Spinbox(root, from_=0.0, to=10.0, format="%.2f",increment=0.01, width=4, relief="sunken", repeatdelay=500, repeatinterval=100,font=(selectedfont, 12), bg="#212121", fg="#111", state="readonly")
min = Spinbox(root, from_=0.0, to=10.0, format="%.2f",increment=0.01, width=4, relief="sunken", repeatdelay=500, repeatinterval=100,font=(selectedfont, 12), bg="#212121", fg="#111", state="readonly")
max = Spinbox(root, from_=0.0, to=10.0, format="%.2f",increment=0.01, width=4, relief="sunken", repeatdelay=500, repeatinterval=100,font=(selectedfont, 12), bg="#212121", fg="#111", state="readonly")
